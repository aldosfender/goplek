<header>
    ...
    <!-- Modal -->
    <div class="modal fade" id="pwd3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nombre de usuario o telefono ya están registrados.</h5>
                </div>
                    ...
                    <div class="row flex-center pt-5 mt-3">
                        <div class="col-md-6 text-center text-md-left mb-5">
                            <div class="white-text"><br><br>
                                ...
                                Comida Rápida en CU</h1>
                                <hr class="hr-light mb-5 wow fadeInLeft" data-wow-delay="0.3s">
                                <div class="card wow fadeInLeft" data-wow-delay="0.3s">  
                                <div class="card-body">
                                    <h6 style="text-align: justify;" class="wow fadeInLeft" data-wow-delay="0.3s">Somos una alternativa tecnológica buscando agilizar el pedido y entrega de alimentos dentro y en los alrededores de ciudad universitaria. Desde opciones accesibles a casi cualquier bolsillo; antojitos y entremeses por mencionar los más populares hasta establecimientos reconocidos por su alta calidad y servicio.</h6></div></div>
                                <br>
                        ...
                        <div class="col-md-6 col-xl-5" style="padding-top: 20px; padding-bottom: 25px;">
                              ...
                              <form method="POST" action="<?php echo base_url();?>index.php/welcome/register">  
                                <div class="card-body">
                                    ...
                                    <div class="md-form">
                                        ...
                                        <label for="matricula" data-toggle="tooltip" title="Matricula BUAP" data-placement="left">Matrícula</label>
                                    </div>
                                    <div class="md-form">
                            ...
                            </div><script type="text/javascript" src="js/valida_registro.js"></script> 
                            <!--/.Form--> <script type="text/javascript" src="../../js/valida_registro.js"></script>
                        </div> 
                    </div>
                </div>
            </div>
